...
Read the learnings database at ~/.codex/learnings/learnings.jsonl. Each line is a JSON object with fields: title, category, services, problem, solution, why_it_matters.
